...
class AdminProductsScreen extends BaseStatefulWidget {
  const AdminProductsScreen({super.key});

  @override
  BaseState<AdminProductsScreen> createState() => _AdminProductsScreenState();
}

class _AdminProductsScreenState extends BaseState<AdminProductsScreen> {
