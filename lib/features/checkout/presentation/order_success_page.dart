      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              ColorConst.primaryColor.withValues(alpha: 0.15),
              ColorConst.secondaryColor.withValues(alpha: 0.1),
              ColorConst.colorFF10B981.withValues(alpha: 0.1),
            ],
          ),
        ),
        child: SafeArea(
        ...
        return Transform.scale(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: ColorConst.colorFF10B981.withValues(alpha: 0.4),
                  blurRadius: 24,
